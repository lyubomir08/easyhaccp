...
export default function Sidebar() {
    const { role, isCatering, isWholesale } = useUser();
            ...
            <nav className="py-4">
                {role === "admin" && (
                    <>
                        ...
                        <NavLink to="/admin/firms" className={({ isActive }) =>
                            `${link} ${isActive ? activeLink : ""}`
                        }>
                            Фирми
                        </NavLink>

                        <NavLink to="/admin/objects" className={({ isActive }) =>
                            `${link} ${isActive ? activeLink : ""}`
                        }>
                            Обекти
                        </NavLink>
                ...
                {role === "owner" && (
                    <>
                        ...
                        <NavLink to="/myFirm" className={({ isActive }) =>
                            `${link} ${isActive ? activeLink : ""}`
                        }>
                            Профил на фирмата
                        </NavLink>

                        <NavLink to="/myObjects" className={({ isActive }) =>
                            `${link} ${isActive ? activeLink : ""}`
                        }>
                            Моите обекти
                        </NavLink>
                ...
                {role === "manager" && (
                    <>
                        ...
                        <NavLink to="/myObject" className={({ isActive }) =>
                            `${link} ${isActive ? activeLink : ""}`
                        }>
                            Данни за обекта
                        </NavLink>
                ...
                {/* Групи храни - скрити за търговия на едро */}
                {!isWholesale && (
                ...
                {/* Фритюрници - скрити за търговия на едро */}
                {!isWholesale && (
                ...
                {/* Смяна на мазнина - скрита за търговия на едро */}
                {!isWholesale && (
